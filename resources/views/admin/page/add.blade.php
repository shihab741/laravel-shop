          ...
          <form action="{{route('page.store')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                  <label>Slug</label>
                  <input type="text" name="url" class="form-control" placeholder="Enter page url...">
                </div>

                <div class="form-group">
                  <label>Heading</label>
                  <input type="text" name="heading" class="form-control" placeholder="Enter page heading...">
                </div>


                <div class="form-group">
                  <label>Page content</label>
                    <textarea id="editor1" name="page_content" rows="10" cols="80"></textarea>                  
                </div>
