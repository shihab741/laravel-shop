            ...
            <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="file" name="photo" class="form-control" id="imageInputFile">
                   <div class="image-preview" id="imagePreview">
                      <img src="{{ asset('/') }}uploads/user-images/{{ $user->photo }}" alt="" class="image-preview__image">
                ...
                <div class="form-group">
                    <label class="radio-inline">
                        <input type="radio" name="status" id="optionsRadiosInline1" value="1" {{ $user->status == 1 ? 'checked' : '' }}><strong>Active</strong> 
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="status" id="optionsRadiosInline2" value="0" {{ $user->status == 0 ? 'checked' : '' }}><strong>Inactive</strong>
                    </label>
                </div>
