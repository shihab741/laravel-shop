...
@section('body')
	...
	<div class="welcome">
		<div class="container">
			<div class="well">
				<h3>Dear {{Session::get('customerName')}} your shipping information goes here.</h3>
			</div>
				...
				<div class="col-md-12">				
						...
						{{Form::open(['route'=> 'new-shipping', 'method' => 'POST'])}}
							<div class="form-group">
								...
								<input type="text" class="form-control" placeholder="Name" name="full_name" required="" value="{{$customer->first_name.' '.$customer->last_name}}">
							</div>
							<div class="form-group">
